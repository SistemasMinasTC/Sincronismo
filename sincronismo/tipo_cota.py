...
def convert(conn_ifx, conn_sql, linha_log):
    ...
    linha_log.pk = cod_clube+'|QT|'+linha_log.pk

    Chave = recordtype('Chave', 'cod_clube, cod_tipo_associado, cod_tipo_cota')
    ...
    cr_ifx.execute(f"""
        select
            ...
            'QT' as cod_tipo_associado,
            des_tipo_cota,
            cod_tipo_cota
        from {linha_log.banco}:tipo_cota as tipo_cota
        where
            cod_tipo_cota = ?
    """,(
        chave.cod_tipo_cota,
