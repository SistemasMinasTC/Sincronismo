...
def convert(conn_ifx, conn_sql, linha_log):
    ...
    if cr_sql.rowcount == 0:
        ...
        cr_sql.execute("""select ident_current('Acompanhante')""")
        pkSql = cr_sql.fetchval()
