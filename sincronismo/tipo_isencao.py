...
def convert(conn_ifx, conn_sql, linha_log):
    ...
    for cod_tipo_associado in ('QT','CT'):
        linha_log.pk = cod_clube+'|'+cod_tipo_associado+'|'+pk

        Chave = recordtype('Chave', 'cod_clube, cod_tipo_associado, cod_tipo_isencao')
